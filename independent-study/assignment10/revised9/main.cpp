//Matthew Hill
//Assignment 10 - Revised Assignment 9
/*Objectives:
    1. Use pointers
*/
...
//Functions that assign passed arrays to pointers
//The arrays can then be accessed with the pointer name
//Incidentally, the pointer names in this program are the same as the array names in main()
