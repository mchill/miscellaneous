//Matthew Hill
//Assignment 10 - Revised Assignment 8
/*Objectives:
    1. Use pointers
*/
...
int main()
{
    ...
    //Passes the memory address of the variables
    Swap(&char1, &char2);
    Swap(&int1, &int2);
    Swap(&float1, &float2);
...
{
    char chartemp = *char1; //Temporary char initialized to value stored in the address char1
    *char1 = *char2;    //Value stored in the address char2 equals value stored in the address char1
    *char2 = chartemp;  //Value stored in the acdress char1 equals the temporary char
}
