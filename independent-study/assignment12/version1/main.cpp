...
p1, p2, p3, p4, p5, p6, p7, p8; //8 objects of struct Product

void initialize_products(Product *product_list[]);
void process_order(Product *product_list[]);
void print_order(Product *product_list[]);

int main()
{
    Product *product_list[NUM_PRODUCTS];    //An array of size number of products of pointers to each object of struct Product

    //Calls the initialize, process, and print functions, passing the array of pointers
    initialize_products(product_list);
...
void initialize_products(Product *product_list[])
{
    product_list[0] = &p1;  //Assigns the address of object p1 to product_list[0]
    p1.number = 1;
    p1.description = "ShamWow";
    p1.unit_price = 19.95;
    p1.quantity = 0;

    product_list[1] = &p2;
    p2.number = 2;
    p2.description = "Puppy";
    p2.unit_price = 52.00;
    p2.quantity = 0;

    product_list[2] = &p3;
    p3.number = 3;
    p3.description = "Test Answers";
    p3.unit_price = 59.99;
    p3.quantity = 0;

    product_list[3] = &p4;
    p4.number = 4;
    p4.description = "Mystery Meat";
    p4.unit_price = 78.90;
    p4.quantity = 0;
    ...
    p5.number = 5;
    p5.description = "Bike";
    p5.unit_price = 199.99;
    p5.quantity = 0;

    product_list[5] = &p6;
    p6.number = 6;
    p6.description = "Concert Tickets";
    p6.unit_price = 250.50;
    p6.quantity = 0;

    product_list[6] = &p7;
    p7.number = 7;
    p7.description = "Love";
    p7.unit_price = 1233.33;
    p7.quantity = 0;

    product_list[7] = &p8;
    p8.number = 8;
    p8.description = "A NEW CAR!";
    p8.unit_price = 21999.99;
    p8.quantity = 0;
}
